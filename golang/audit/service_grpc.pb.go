...
func (c *auditServiceClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PingResponse, error) {
...
func (UnimplementedAuditServiceServer) Ping(context.Context, *empty.Empty) (*PingResponse, error) {
...
func _AuditService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServiceServer).Ping(ctx, req.(*empty.Empty))
	}
