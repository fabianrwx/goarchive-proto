...
var file_authentication_service_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x22, 0x28, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x52,
	...
	0x44, 0x41, 0x50, 0x10, 0x01, 0x32, 0x92, 0x02, 0x0a, 0x15, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e,
	...
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x65, 0x6e,
...
var file_authentication_service_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
var file_authentication_service_proto_depIdxs = []int32{
	...
	12, // 1: AuthenticationService.Ping:input_type -> google.protobuf.Empty
	10, // 2: AuthenticationService.GetClaims:input_type -> GetClaimsRequest
	2,  // 3: AuthenticationService.Login:input_type -> LoginRequest
	4,  // 4: AuthenticationService.Logout:input_type -> LogoutRequest
	8,  // 5: AuthenticationService.RefreshToken:input_type -> RefreshTokenRequest
	1,  // 6: AuthenticationService.Ping:output_type -> PingResponse
	11, // 7: AuthenticationService.GetClaims:output_type -> GetClaimsResponse
	3,  // 8: AuthenticationService.Login:output_type -> LoginResponse
	5,  // 9: AuthenticationService.Logout:output_type -> LogoutResponse
	9,  // 10: AuthenticationService.RefreshToken:output_type -> RefreshTokenResponse
